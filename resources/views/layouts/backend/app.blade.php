...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('/easylogo.png') }}">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.2/css/all.min.css" />
     ...
     <!-- <link href="{{ asset('assets/backend/css/cric.css') }}" rel="stylesheet" type="text/css">
     <link href="{{ asset('assets/backend/css/materialicon.css') }}" rel="stylesheet"  >
     <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" type="text/css">
